...
public:
	...
	Controller();
	~Controller();
	void saveDataFile(const char* filename, unsigned short * images, int numTrials, int numPts, double intPts, int num_fp_pts, int width, int height, short * rliLow, short * rliHigh, short * rliMax, short sliceNo, short locNo, short recNo, int program, int intTrials);
