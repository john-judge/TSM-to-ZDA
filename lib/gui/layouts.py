...
class Layouts:
    ...
    def create_analysis_tab(gui):
        ...
        return [
            ...
            sg.Checkbox('Latency Map', size=checkbox_size, key="Latency Map Export",
                            enable_events=True, default=gui.controller.is_export_latency_maps,
                            tooltip="Export latency maps to PhotoZ dat files."),
            sg.Checkbox('RLI Map', size=checkbox_size, key="RLI Map Export",
                            enable_events=True, default=gui.controller.is_export_rli_maps,
                            tooltip="Export RLI maps to PhotoZ dat files."),],
            ...
            [sg.Text('ROIs Exclusion Keyword:'), sg.InputText(key="ROIs Exclusion Keyword",
                default_text=gui.controller.export_rois_exclusion_keyword,
                enable_events=True,
                size=field_size,
                tooltip='Keyword to exclude ROI file names from export. If an ROI file name contains this keyword, it will not be selected for export, even if it contains the selection keyword.'),
        ...
        return [
            [sg.Text("Poly Skip Window:"), 
             sg.InputText(key="skip_window_start",
                ...
                enable_events=True,
                size=field_size,
                tooltip='Polynomial baseline correction skip window start. Only used if Headless Mode is enabled.'),
             sg.Text("Width:"), 
             sg.InputText(key="skip_window_width",
                default_text=str(gui.controller.skip_window_width),
                enable_events=True,
                size=field_size,
                tooltip='Polynomial baseline correction skip window width. Only used if Headless Mode is enabled.'),],
            [sg.Text("Measure Window:"), 
             sg.InputText(key="measure_window_start",
                default_text=str(gui.controller.measure_window_start),
                enable_events=True,
                size=field_size,
                tooltip='Measure window start. Only used if Headless Mode is enabled.'),
             sg.Text("Width:"), 
             sg.InputText(key="measure_window_width",
                default_text=str(gui.controller.measure_window_width),
                enable_events=True,
                size=field_size,
    ...
    def create_annotator_tab(self, gui):
        ...
        return [
            ...
            [sg.Text('Brush Size:', size=(10, 1)), 
             ...
             sg.Checkbox("Load & Align TIFs", size=(15, 1), key="roi_annotator_load_align_tifs",
                enable_events=True, default=gui.controller.roi_annotator_load_align_tifs,
                tooltip="When checked, load and align TIF image stacks for annotation. TIF must be named <slice>-<loc>*.tif"),],
