...
class GUI:
    ...
    def update_gui_from_save_dict(self, save_dict):
        ...
        self.window["Amplitude Trace Export"].update(save_dict['Controller'].get('is_export_amp_traces', False))
        self.window["SNR Trace Export"].update(save_dict['Controller'].get('is_export_snr_traces', False))
        self.window["Latency Trace Export"].update(save_dict['Controller'].get('is_export_latency_traces', False))
        self.window["Halfwidth Trace Export"].update(save_dict['Controller'].get('is_export_halfwidth_traces', False))
        self.window["Trace Export"].update(save_dict['Controller'].get('is_export_traces', False))
        self.window['Trace_export_non_polyfit'].update(save_dict['Controller'].get('is_export_traces_non_polyfit', False))
        self.window["SD Export"].update(save_dict['Controller'].get('is_export_sd_traces', False))
