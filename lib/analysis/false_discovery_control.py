import numpy as np
""" This is taken from scipy.stats.false_discovery_control: https://github.com/scipy/scipy/blob/v1.14.0/scipy/stats/_morestats.py#L4801-L4997
    It is copied here because SciPy.stats v1.11.0 is not available in the current environment.
"""
